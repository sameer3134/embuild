        ...
        <div className="lg:w-full mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <p className="leading-relaxed font-sans text-xl font-semibold">
              "Welcome to Embuild Trading Solutions, a private limited company
              specializing in the construction industry. We excel in planning,
              designing, building, and maintaining structures and infrastructure
